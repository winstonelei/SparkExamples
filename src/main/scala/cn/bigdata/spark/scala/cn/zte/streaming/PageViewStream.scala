...
import main.scala.bigdata.spark.scala.cn.zte.streaming.PageView
...
/*    println("pageCounts = " + pageCounts.print())

    println("slidingPageCounts = " + slidingPageCounts.print())

    println("errorRatePerZipCode = " + errorRatePerZipCode.print())

    println("activeUserCount = " + activeUserCount.print())

    println("popularUsersSeen"+ pageViews.map(view => (view.userID, 1))
